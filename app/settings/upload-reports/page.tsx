  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[var(--foreground)]">Upload Amazon Reports</h1>
      ...
      <Card className="bg-[var(--card)]/50 border-[var(--border)]">
        <CardHeader>
          <CardTitle className="text-[var(--foreground)]">How to get reports from Amazon</CardTitle>
        </CardHeader>
        <CardContent className="text-[var(--foreground)] space-y-2">
          ...
          >
            ...
            {uploading ? (
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-[var(--foreground)]">Processing files...</p>
              </div>
            ) : (
              <div className="flex flex-col items-center gap-4">
      ...
      {results.length > 0 && (
        <Card className="bg-[var(--card)]/50 border-[var(--border)]">
          <CardHeader>
            <CardTitle className="text-[var(--foreground)]">Upload Results</CardTitle>
            <CardDescription>
